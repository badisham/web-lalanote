                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="d-sm-flex p-3 align-items-center justify-content-between mb-4">
                            <h6 class="h3 mb-0 text-gray-800">รางวัล</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT *,ms_reward.id as reward_id,institution.name as institution_name, ms_reward.name as reward_name FROM ms_reward INNER JOIN institution ON institution.id = ms_reward.institution_id $where";
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                    <td>
                                                        <button class="btn btn-danger" onclick="SweetAlertOk('ต้องการลบ ?','warning','services/reward.php?id=<?= $row['reward_id'] ?>&delete=1')">ลบ</button>
                                                    </td>
                                                </tr>
                                        <?php
                                            }
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <form action="http://localhost:3001/reward" method="post" enctype="multipart/form-data" target="popup">
                        ...
                        ?>
                        <div class="form-group">
                            <label for="use_star_point">ใช้ ดาว</label>
                            <input name="use_star_point" type="number" class="form-control" min="1" id="use_star_point" placeholder="">
                        </div>
                        <div class="form-group">
